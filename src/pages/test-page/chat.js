...
import { TextboxWithoutShadow } from "../../components/atoms";
import { Bubble, BubbleMe } from "../../components/molecules";
      ...
      <div className="chat__wrapper">
        <div className="chat__header">
          ...
          <div className="prod-detail__pages__property__detailBuying__left__dev-info__name">
            ...
            <p className="prod-detail__pages__property__detailBuying__left__dev-info__location">
              Yogyakarta{" "}
              <span className="chat__header__online">&bull; ONLINE</span>
            </p>
          </div>
        </div>
        <div className="chat__body">
          <Bubble
            name="Kianna Curtis"
            time="8.10 PM"
            chatContent={[`Halo selamat siang`]}
          />
          <BubbleMe
            name="PT. Suskses Indo Maju"
            time="8.10 PM"
            chatContent={[`Ada yang bisa kami bantu?`]}
            isRead
          />
          <Bubble
            name="Kianna Curtis"
