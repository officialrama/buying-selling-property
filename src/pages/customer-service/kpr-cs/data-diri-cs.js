...
const handleKJPPNotaris = () => {
  ...
  return (
    ...
    <p className="text-xl text-[#292929] font-bold mb-4">Informasi Pribadi</p>
      ...
      <TextboxLabel placeholder="Masukkan Nama Lengkap" name="fullName" value={inputs?.fullName?.value} onChange={handleInput.handleName} warnText={inputs?.fullName?.msgError} />
      </div>
      <div className="flex flex-col gap-2">
      <p className="text-xs font-semibold text-[#292929] flex flex-row">NIK<p className="text-[#E84040]">*</p></p>     
      <TextboxLabel placeholder="Masukkan NIK" name="nik" value={inputs?.nik?.value} onChange={handleInput.handleNumberInput} maxLength="16" warnText={!inputs?.nik?.value ? "NIK tidak boleh kosong" : !inputs?.nik?.isValid ? inputs?.nik?.msgError : ""} />
      </div>
      <div className="flex flex-col gap-2">
      <p className="text-xs font-semibold text-[#292929] flex flex-row">Tempat Lahir<p className="text-[#E84040]">*</p></p>     
      <TextboxLabel placeholder="Masukkan Tempat Lahir" name="pob" value={inputs?.pob?.value} onChange={handleInput.handleLetterInput} warnText={!inputs.pob?.isValid && "Tempat Lahir Wajib Diisi"} />
      </div>
        <div>
        <div className="flex flex-col gap-2">
        <p className="text-xs font-semibold text-[#292929] flex flex-row">Tanggal Lahir (min. 17 tahun)<p className="text-[#E84040]">*</p></p>     
          </div>
          <div>
            <DatePicker
              onChange={(e) => {
        ...
        <div className="flex flex-col gap-2">
        <p className="text-xs font-semibold text-[#292929] flex flex-row">No Handphone<p className="text-[#E84040]">*</p></p> 
        <TextboxDropdown 
        ...
        <div className="flex flex-col gap-2">
        <p className="text-xs font-semibold text-[#292929] flex flex-row">Jenis Kelamin<p className="text-[#E84040]">*</p></p>  
          <Dropdown
        ...
        <div className="flex flex-col gap-2">
        <p className="text-xs font-semibold text-[#292929] flex flex-row">Status Kawin<p className="text-[#E84040]">*</p></p>  
          <Dropdown
        ...
        <div className="flex flex-col gap-2">
        <p className="text-xs font-semibold text-[#292929] flex flex-row">Agama<p className="text-[#E84040]">*</p></p>  
          <Dropdown
      ...
      <TextboxLabel
        ...
        <div className="flex-shrink-0">
        <Button
          className={"mt-6 font-medium text-sm w-full h-10 curo"}
          buttonColor="bluefigma"
          textColor="white"
          onClick={handleLoadPinLoc}
          paddingSize={"padding-0"}
      ...
      <div className="flex flex-row gap-1">
        <input
          ...
          />
          <p className="text-sm text-[#292929] whitespace-nowrap mobile:whitespace-normal">Kantor Cabang Terdekat</p>
          </div>
           <div className="flex flex-row gap-1">
      <input
            type="radio"
          ...
          />
          <p className="text-sm text-[#292929] whitespace-nowrap mobile:whitespace-normal">Semua Kantor Cabang</p>
          </div>
        {kcForm.state === "nearby" ?
          <KCAutocompleteRadio
            value={kcDescVal}
      ...
      {!inputs?.ukerCode?.value || !inputs?.ukerName?.value ? (
          ...
          <button
                ...
                className="inline-flex flex-row whitespace-nowrap flex-shrink-0 gap-1 w-[264px] mobile:w-[252px] h-11 rounded-md border border-[#1078CA] shadow-sm px-4 py-2 bg-white text-base font-bold hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 text-[#1078CA]"
              >
                List Daftar KJPP dan Notaris
              </button>
        <div className="flex flex-col gap-2 mt-10">
          <p className="font-bold text-2xl" >Dokumen Pendukung</p>
          <p className="font-semibold text-xs">Upload dokumen pendukung dalam format .pdf .jpg atau .png (Jika ada).</p>
          <DocumentCS 
           files={files}
           alertImg={alertImg}
           setFiles={setFiles}
