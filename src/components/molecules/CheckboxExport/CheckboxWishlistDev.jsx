...
function CheckboxWishlistDev({ tblAdmin, checkProps, downloadData, setDownloadData, dataTemp, header, children }) {
...
CheckboxWishlistDev.propTypes = {
  header: PropTypes.array.isRequired,
};

CheckboxWishlistDev.defaultProps = {
  header: [{ name: "", class: "" }],
};

export default CheckboxWishlistDev;
