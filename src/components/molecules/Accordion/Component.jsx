...
const Component = ({ question, answer, image }) => {
  ...
  return (
    <div className="border-[1px] border-[#D3D4D4] rounded-lg p-4">
      ...
      >
        <p className="text-base font-semibold text-[#292929]">{question}</p>
        {isActive ? (
          <svg
      ...
      {isActive && <p className="text-[#777777] mt-2 font-normal text-base">{answer}</p>}
