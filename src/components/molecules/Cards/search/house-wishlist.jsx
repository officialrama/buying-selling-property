...
import { formatRupiahNumber, formatRupiahWord, toTitleCase, trimStr } from "../../../../helpers/string";
import { Button } from "../../../atoms";
const convertRupiah = require("rupiah-format");

const HouseCardWishlist = ({ index, data, isVirtual, onClick, resSearch, onClickDelete, projectData }) => {
        ...
        <>
          <div className="w-[250px] mobile:w-full tab:w-full">
            <CarouselThumbImage
              ...
              isVirtual={isVirtual}
              imgClassName="h-80 mobile:h-32 w-full"
          ...
          >
            ...
            <div className="flex flex-row">
              <p className="text-sm text-[#B5B6B6] font-normal line-through">
                {formatRupiahWord(data?.detailProperti?.hargaProperti)}
              </p> 
              <p className="text-[#1078CA] font-bold text-lg">
              {formatRupiahWord(data?.detailProperti?.hargaAkhir) }
            </p>
            </div>
              : <></>}
...
export default HouseCardWishlist;
