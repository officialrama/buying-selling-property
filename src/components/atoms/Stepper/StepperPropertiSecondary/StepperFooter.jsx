...
function StepperFooter({
  ...
  return (
    <>
    <div className="absolute w-full z-10 flex justify-center items-center bg-white sticky bottom-0 h-[96px] relative" style={{boxShadow: "0px 5px 5px 2px rgba(0, 0, 0, 1)"}}>
    {/* <div
      className={
        type === "sell"
    ...
    > */}
      <div className="flex flex-row gap-2 justify-end mobile:mx-0 tab:mx-[30px] smallPc:mx-[30px] mx-32 w-full">
        <div>
          <Button
        ...
        <div>
          ...
          >
            {isLastStep && type === "sell"
              ? "Publikasi"
              : isLastStep && type === "properti-secondary"
                ? "Simpan"
                : "Lanjutkan"}
          </Button>
        </div>
