...
const SideMenuSales = ({ title, desc, children, action }) => {
  ...
  return (
    <div>
      ...
      <div className="flex">
        ...
        {width >= 275 ? <aside
          className={`sm-admin__wrapper ${saState.showAdmMenu ? "sm-admin__wrapperSmallPcAct" : "sm-admin__wrapperSmallPc"} largePc:w-60 mobile:w-60 tab:w-60 smallPc:w-60`}
          aria-label="Sidebar"
        >
          <div className="sm-admin__sidebar-wrap">
            <ul className="sm-admin__ul-parent">
        ...
        <main onClick={() => dispatch(showAdmMenu(false))} className="bg-[#F9FAFB] w-full">
          <div className="largePc:m-[16px] smallPc:m-[16px] p-[50px] bg-white rounded-md">
