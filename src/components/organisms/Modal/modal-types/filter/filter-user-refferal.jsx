...
function FilterUserRefferal({ otherProps }) {
            ...
            <div className='my-2'>
                <FilterCard title=" ">
                    <div className="filter-search__wrapper__baseInputTextNoMargin">
                        ...
                        <Checkbox label="Nama" fontSize="16px" name="customerName" checked={otherProps?.filterCheck?.includes("customerName") ? true : false} onChange={(e) => handleChecked(e)} />
                            ...
                            <Checkbox label="Nomor Handphone" fontSize="16px" name="mobileNo" checked={otherProps?.filterCheck?.includes("mobileNo") ? true : false} onChange={(e) => handleChecked(e)} />
                        ...
                        <div className="filter-search__wrapper__options">
                            <Checkbox label="Kode Properti" fontSize="16px" name="propertiID" checked={otherProps?.filterCheck?.includes("propertiID") ? true : false} onChange={(e) => handleChecked(e)} />
...
export default FilterUserRefferal