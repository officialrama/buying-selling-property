...
function FilterSalesRefferal({ otherProps }) {
                ...
                <FilterCard title=" ">
                    <div className="filter-search__wrapper__baseInputTextNoMargin">
                        <div className="filter-search__wrapper__options">
                            <Checkbox label="Nama Sales" fontSize="16px" name="salesName" checked={otherProps?.filterCheck?.includes("salesName") ? true : false} onChange={(e) => handleChecked(e)} />
                            <Checkbox label="Email" fontSize="16px" name="salesEmail" checked={otherProps?.filterCheck?.includes("salesEmail") ? true : false} onChange={(e) => handleChecked(e)} />
                        ...
                        <div className="filter-search__wrapper__options">
                            <Checkbox label="Nomor HP" fontSize="16px" name="salesPhone" checked={otherProps?.filterCheck?.includes("salesPhone") ? true : false} onChange={(e) => handleChecked(e)} />
                            {/* <Checkbox label="Tanggal Daftar" fontSize="16px" name="createdAt" checked={otherProps?.filterCheck?.includes("nik") ? true : false} onChange={(e) => handleChecked(e)} /> */}
                            ...
                            {/* <Checkbox label="Regional Office" fontSize="16px" name="regionalOffice" checked={otherProps?.filterCheck?.includes("regionalOffice") ? true : false} onChange={(e) => handleChecked(e)} /> */}
                            {/* <Checkbox label="Branch Office" fontSize="16px" name="branchOffice" checked={otherProps?.filterCheck?.includes("branchOffice") ? true : false} onChange={(e) => handleChecked(e)} /> */}
                            ...
                            {/* <Checkbox label="Jenis Properti" fontSize="16px" name="jenisProperti" checked={otherProps?.filterCheck?.includes("jenisProperti") ? true : false} onChange={(e) => handleChecked(e)} />
...
export default FilterSalesRefferal