...
function FilterSalesFinal({ otherProps }) {
                ...
                <FilterCard title=" ">
                    <div className="filter-search__wrapper__baseInputTextNoMargin">
                        ...
                        <Checkbox label="NIK" fontSize="16px" name="nik" checked={otherProps?.filterCheck?.includes("nik") ? true : false} onChange={(e) => handleChecked(e)} />
                            ...
                            {/* <Checkbox label="Jenis Properti" fontSize="16px" name="jenisProyek" checked={otherProps?.filterCheck?.includes("jenisProyek") ? true : false} onChange={(e) => handleChecked(e)} /> */}
...
export default FilterSalesFinal