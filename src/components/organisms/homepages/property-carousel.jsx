...
import { PropertyList } from "../../molecules";

const PropertyCarousel = ({ property, is360 = false }) => {
  let isMobile = false;
  ...
  return (
    <div className="landing-page city-carousel relative pl-7">
      <Carousel
        cols={isMobile ? 1 : 4}
        rows={1}
        gap={0}
        hideArrow={property?.length >4 ? false : true}
